...
*   **[Cloud Native PostgreSQL (CNPG)](examples/cloudnativepg/README.md)**: How to deploy a production-style PostgreSQL cluster using the CloudNativePG operator — covers the Cluster CRD, auto-generated credentials, read/write vs read-only service endpoints, streaming replication, and failover.
